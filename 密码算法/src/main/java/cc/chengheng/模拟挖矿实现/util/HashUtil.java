...
public class HashUtil {
    ...
    /**
     * 16进制字符串, 先转字节，让16进制字节在hash，在转16进制
     * @param data 16进制字符串
     * @return
     */
    public static String sha256HexString(String data) {
        String result = null;
        try {
            byte[] hexArr=hexStrToHexBytes(data);
            return sha256Bytes(hexArr).toLowerCase();
